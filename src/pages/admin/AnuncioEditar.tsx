    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          texto_botao: data.texto_botao || 'Saiba Mais',
          tipo: data.tipo,
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold text-foreground">Editar Anúncio</h1>
          <p className="text-muted-foreground">Atualizar informações do anúncio</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            ...
            <CardDescription>Atualize os dados do anúncio</CardDescription>
          </CardHeader>
