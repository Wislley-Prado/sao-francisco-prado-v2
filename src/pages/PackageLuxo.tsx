    ...
    <CardHeader className="text-center pb-4">
      ...
      <div className="mb-4 p-4 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl border border-red-200">
        ...
        <div className="text-xs text-gray-600 mt-1">
          Economia de R$ 2.000 por pessoa
        </div>
      </div>
              ...
              <div className="mt-4 sm:mt-6 text-center">
                <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-sm sm:text-base">
                  <div className="flex items-center">
                    <span className="text-amber-300 font-semibold">Espécie:</span>
                    <span className="ml-2">Dourado (Salminus brasiliensis)</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-amber-300 font-semibold">Local:</span>
                    <span className="ml-2">Cachoeira da Escadinha</span>
                  </div>
                  <div className="flex items-center">
                    <span className="text-amber-300 font-semibold">Rio:</span>
